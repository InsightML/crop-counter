...
match. ``points`` turns the fetched boxes into the COCO **keypoints** document
this package's native point head trains on — in a separate data root, with int
ids; see :func:`bbox_centres_to_keypoints`.
